...
Il est possible de remonter à Eulérian des actions effectuées sur des éléments HTML hors composants du DSApitech.
...
Les différents types d’action sont définis dans : `src/dsapitech/analytics/script/analytics/action/type.js`
