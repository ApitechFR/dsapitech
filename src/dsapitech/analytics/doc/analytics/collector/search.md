...
`window.dsapitech.analytics.search.engine`
...
`window.dsapitech.analytics.search.results`
...
`window.dsapitech.analytics.search.terms`
...
`window.dsapitech.analytics.search.category`
...
`window.dsapitech.analytics.search.theme`
...
`window.dsapitech.analytics.search.type`
...
`window.dsapitech.analytics.search.method`
...
`window.dsapitech.analytics.search.reset(clear)`
